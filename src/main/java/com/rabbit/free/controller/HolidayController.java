...
public class HolidayController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "startDate", value = "查询起始日期(yyyy-MM-dd)", required = true, dataType = "String"),
            @ApiImplicitParam(name = "endDate", value = "查询截止日期(yyyy-MM-dd)", required = false, dataType = "String")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "startDate", value = "查询起始日期(yyyy-MM-dd)", required = false, dataType = "String"),
            @ApiImplicitParam(name = "endDate", value = "查询截止日期(yyyy-MM-dd)", required = false, dataType = "String")
    })
    @ApiResponse(code = 200, message = "日期", responseHeaders = {@ResponseHeader(name = "application/json")})
